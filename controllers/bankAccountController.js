...
// 3100 = Retained Earnings (correct for historical opening balances)
// NOT 3200 which is Current Period Profit (system-only, allowDirectPosting: false)
      ...
      try {
        ...
        const je = await JournalService.createEntry(companyId, req.user._id, {
          ...
          lines: [
            ...
            JournalService.createCreditLine(RETAINED_EARNINGS_CODE, openingBal, `Opening balance: ${account.name}`),
          ],
